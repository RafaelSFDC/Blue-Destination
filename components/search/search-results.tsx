...
import type { Package, Destination } from "@/lib/mock-data"
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {resultType === "packages" &&
          results.map((item) => {
            ...
            return <PackageCard key={pkg.id} package={pkg} />
          })}
      ...
      {hasMore && (
        <div className="mt-8 flex justify-center">
          <Button onClick={onLoadMore} variant="outline" size="lg" disabled={isLoading}>
            {isLoading ? (
              <>
