...
export function Notifications() {
  ...
  // Retorna null se estiver carregando ou se não houver usuário
  ...
  useEffect(() => {
    if (isOpen && unreadCount > 0) {
      // Aqui precisaríamos implementar uma função para marcar notificações como lidas
      // através de uma API ou serviço
      // Por enquanto, deixaremos como comentário
        ...
        <DropdownMenuLabel className="flex items-center justify-between">
          ...
          {notifications.length > 0 && (
            <Button
              ...
              onClick={() => {
                // Implementar função para limpar notificações
