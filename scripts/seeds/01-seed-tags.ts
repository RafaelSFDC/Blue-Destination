...
import { loadCollectionIds, createDocuments, documentExists, generateSlug, generateISODate } from './utils';
...
const destinationTags = [
  ...
  { name: 'Família', type: 'destination', color: '#8b5cf6', icon: 'people-group' },
  { name: 'Luxo', type: 'destination', color: '#a16207', icon: 'crown' },
  { name: 'Econômico', type: 'destination', color: '#65a30d', icon: 'piggy-bank' },
  { name: 'Exótico', type: 'destination', color: '#d946ef', icon: 'palm-tree' },
  { name: 'Ilha', type: 'destination', color: '#0284c7', icon: 'island-tropical' },
  { name: 'Deserto', type: 'destination', color: '#ca8a04', icon: 'sun' },
];
