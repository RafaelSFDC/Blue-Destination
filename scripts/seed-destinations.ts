...
const destinationsData = [
  {
    ...
    description: "Cidade maravilhosa com praias deslumbrantes, o Cristo Redentor e uma vida noturna vibrante.",
    price: 1500,
    rating: 4.7,
    reviewCount: 1250,
  ...
  },
  {
    ...
    description: "Arquipélago paradisíaco com as mais belas praias do Brasil, ideal para mergulho e contato com a natureza.",
    price: 3200,
    rating: 4.9,
    reviewCount: 850,
  ...
  },
  {
    ...
    description: "Cidade com arquitetura europeia, gastronomia refinada e atrações para toda a família.",
    price: 1800,
    rating: 4.8,
    reviewCount: 1100,
  ...
  },
  {
    ...
    description: "Parque nacional com cachoeiras cristalinas, trilhas e paisagens de tirar o fôlego.",
    price: 1200,
    rating: 4.6,
    reviewCount: 780,
  ...
  },
  {
    ...
    description: "Capital baiana com rica história, cultura afro-brasileira, praias e culinária única.",
    price: 1400,
    rating: 4.5,
    reviewCount: 950,
  ...
  },
  {
    ...
    description: "Destino ecoturístico com rios de águas cristalinas, grutas e rica biodiversidade.",
    price: 1600,
    rating: 4.7,
    reviewCount: 820,
  ...
  },
  {
    ...
    description: "Vila de pescadores transformada em paraíso turístico, com dunas, lagoas e pôr do sol inesquecível.",
    price: 2200,
    rating: 4.8,
    reviewCount: 760,
  ...
  },
  {
    ...
    description: "Lar das impressionantes Cataratas do Iguaçu e da Usina de Itaipu.",
    price: 1700,
    rating: 4.9,
    reviewCount: 1300,
    ...
    for (const destination of destinationsData) {
      try {
        ...
        if (existingDestinations.total > 0) {
          console.log(`Destino '${destination.name}' já existe. Atualizando...`);
          ...
          destinationIds[destination.name] = existingDestinations.documents[0].$id;
        ...
        console.log(`Destino '${destination.name}' criado com sucesso. ID: ${newDestination.$id}`);
