...
const PACKAGES_COLLECTION_ID = process.env.NEXT_PUBLIC_COLLECTION_PACKAGES!;
const ITINERARY_COLLECTION_ID = process.env.NEXT_PUBLIC_COLLECTION_ITINERARY!;
...
try {
  ...
  if (fs.existsSync(destinationIdsPath)) {
    ...
    console.warn(
      "Arquivo destination-ids.json não encontrado. Execute o script seed-destinations.ts primeiro."
    );
  }
} catch (error) {
...
const packagesData = [
  {
    ...
    description:
      "Pacote completo para conhecer o melhor do Rio de Janeiro, incluindo visitas ao Cristo Redentor, Pão de Açúcar, praias e muito mais.",
    ...
    itinerary: [
      {
        ...
        description:
          "Chegada ao Rio de Janeiro, transfer para o hotel e tempo livre para conhecer os arredores.",
      },
      {
        day: 2,
        title: "Cristo Redentor e Centro Histórico",
        description:
          "Visita ao Cristo Redentor pela manhã e tour pelo centro histórico à tarde.",
      },
      {
        day: 3,
        title: "Pão de Açúcar e Praias",
        description:
          "Visita ao Pão de Açúcar pela manhã e tarde livre nas praias de Copacabana e Ipanema.",
      },
      {
        day: 4,
        title: "Maracanã e Lapa",
        description:
          "Tour pelo estádio do Maracanã e noite livre para conhecer a vida noturna da Lapa.",
      },
      {
        day: 5,
        title: "Despedida",
  ...
  },
  {
    ...
    description:
      "Pacote exclusivo para Fernando de Noronha, com passeios de barco, mergulho e tempo livre para curtir as praias paradisíacas.",
    ...
    itinerary: [
      {
        ...
        description:
          "Chegada a Fernando de Noronha, transfer para a pousada e briefing sobre a estadia.",
      },
      {
        day: 2,
        title: "Baía do Sancho",
        description:
          "Visita à Baía do Sancho, eleita várias vezes a praia mais bonita do mundo.",
      },
      {
        day: 3,
        title: "Mergulho em Águas Cristalinas",
        description:
          "Aula e passeio de mergulho com cilindro para observar a rica vida marinha.",
      },
      {
        day: 4,
        title: "Passeio de Barco",
        description:
          "Passeio de barco ao redor da ilha com paradas para mergulho de snorkel.",
      },
      {
        day: 5,
        title: "Praia do Leão",
        description:
          "Visita à Praia do Leão e observação do pôr do sol no Forte de Nossa Senhora dos Remédios.",
      },
      {
        day: 6,
        title: "Dia Livre",
  ...
  },
  {
    name: "Circuito Sul",
    description:
      "Pacote que combina o melhor do Sul do Brasil, incluindo Gramado, Canela e Foz do Iguaçu.",
    ...
    itinerary: [
      ...
      },
      {
        ...
        description:
          "City tour por Gramado e Canela, visitando o Lago Negro, Mini Mundo e Catedral de Pedra.",
      },
      {
        day: 3,
      ...
      },
      {
        ...
        description:
          "Passeio pela Rota do Chocolate com visitas às fábricas e degustação.",
      },
      {
        day: 5,
  ...
  },
  {
    ...
    description:
      "Pacote de aventura na Chapada dos Veadeiros, com trilhas, cachoeiras e contato com a natureza.",
    ...
    itinerary: [
      {
        ...
        description:
          "Chegada a Alto Paraíso de Goiás, transfer para a pousada e briefing sobre as trilhas.",
      },
      {
        day: 2,
        title: "Vale da Lua",
      ...
      },
      {
        ...
        description:
          "Visita à deslumbrante Cachoeira Santa Bárbara e Cachoeira Capivara.",
      },
      {
        day: 4,
        title: "Retorno",
  ...
  },
  {
    ...
    description:
      "Pacote focado na rica cultura e história de Salvador, com visitas ao Pelourinho, igrejas históricas e experiências gastronômicas.",
    ...
    itinerary: [
      {
        ...
        description:
          "Chegada a Salvador, transfer para o hotel e passeio inicial pelo Pelourinho.",
      },
      {
        day: 2,
        title: "Centro Histórico",
        description:
          "Tour completo pelo centro histórico, visitando igrejas, museus e o Elevador Lacerda.",
      },
      {
        day: 3,
        title: "Cultura Afro-Brasileira",
        description:
          "Visita ao Mercado Modelo, aula de capoeira e jantar com show folclórico.",
      },
      {
        day: 4,
        title: "Praias de Salvador",
        description:
          "Passeio pelas praias de Salvador, incluindo o Rio Vermelho e Itapuã.",
      },
      {
        day: 5,
        title: "Despedida",
  ...
  try {
    ...
    for (const packageItem of packagesData) {
      try {
        ...
        console.log(
          `Pacote '${packageItem.name}' criado com sucesso. ID: ${newPackage.$id}`
        );
...
async function updateItinerary(packageId: string, itineraryItems: any[]) {
  try {
    ...
    console.error(
      `Erro ao atualizar itinerários para o pacote ${packageId}:`,
      error
    );
  }
}
